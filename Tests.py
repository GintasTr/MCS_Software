...
colour_data = {"avg_hue": 5000}
closed_data = {"closed_coords": 454, "closed_angle": 20, "colour_data": colour_data}


print closed_data["closed_coords"]
print closed_data["closed_angle"]
print closed_data["colour_data"]["avg_hue"]